...
public class UserMealController {
    ...
    public ResponseEntity<Meal> getMeal(@PathVariable Integer restaurant_id, @PathVariable Integer meal_id) {
    ...
    public ResponseEntity<List<Meal>> getMenu(@PathVariable Integer restaurant_id) {
    ...
    public ResponseEntity<Map<Integer, List<Meal>>> getTodayMenu() {
