...
public class AdminMealController {
    ...
    @PostMapping()
    public ResponseEntity<URI> createMeal(@Valid @RequestBody Meal meal, @PathVariable Long restaurant_id) {
    ...
    @PutMapping("/{meal_id}")
    public ResponseEntity<String> updateMeal(@Valid @RequestBody Meal meal, @PathVariable Long restaurant_id, @PathVariable Long meal_id) {
    ...
    public ResponseEntity<String> deleteRestaurant(@PathVariable Long restaurant_id, @PathVariable Long meal_id) {
